...
module.exports = function (callback) {
    ...
    var handlers = {
        ...
        0: function (data) {
            ...
            // Encipher each pair
            var left = blowfish.encipher(buf1.readInt32BE(0), buf2.readUInt32BE(0));
            var right = blowfish.encipher(buf3.readInt32BE(0), buf4.readUInt32BE(0));

            // Write validation
            validation.writeInt32BE(left[0], 0);
            validation.writeInt32BE(left[1], 4);
            validation.writeInt32BE(right[0], 8);
            validation.writeInt32BE(right[1], 12);
