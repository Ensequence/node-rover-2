...
function Blowfish(k) {
	...
	this.xl_par = 0x0000000000000000;
	this.xr_par = 0x0000000000000000;
...
Blowfish.prototype.encipher = function(left, right) {
	var t = this;
	var Xl = left || t.xl_par;
	var Xr = right || t.xr_par;
