...
module.exports = (function () {
    ...
    function spin(direction, duration) {
        ...
        if (direction == 'clockwise') {
            ...
            return _cmdOverTime([commands.LEFT_FORWARD(), commands.RIGHT_REVERSE()], duration);
        } else {
            debug('spinning counter-clockwise');
            return _cmdOverTime([commands.RIGHT_FORWARD(), commands.LEFT_REVERSE()], duration);
        }
    }
    ...
    Object.keys(apiCommands).forEach(function (method) {
        ...
        api[method] = function (duration) {
            return _cmdOverTime(instr, duration);
        };
    });
