...
module.exports = (function () {
    ...
    // ### stopLeft
    // Stop left track movement
    function stopLeft () {
        _cmdOverTime(commands.LEFT_STOP());
    }

    // ### stopRight
    // Stop right track movement
    function stopRight () {
        _cmdOverTime(commands.RIGHT_STOP());
    }
    ...
    function stop () {
        debug('stop');
        _cmdOverTime([commands.LEFT_STOP(), commands.RIGHT_STOP()]);
    }
